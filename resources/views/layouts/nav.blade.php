...
<body>
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
        <div class="container">
        <img class="navbar-brand fw-bold text-primary" src="{{ asset('images/logo.png') }}" style="height: 50px;">            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('user-reviews.index') }}">Reviews</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="appointmentDropdown">
                            <li>
                                <a class="dropdown-item" href="{{ route('AccountDetails') }}">
                                    Book Appointment
                                </a>
                            </li>
                            <li>
